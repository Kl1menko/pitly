  ...
  return (
    <header className="sticky top-0 z-40 w-full bg-gradient-to-r from-[#d9e8ff] via-[#e7f2ff] to-[#d9e8ff] py-3">
      <div className="mx-auto max-w-6xl px-4">
        <div className="flex items-center gap-4 rounded-full bg-white px-4 py-2 shadow-[0_10px_30px_-12px_rgba(37,99,235,0.35)] ring-1 ring-blue-50 md:px-6">
          ...
          <div className="ml-auto flex items-center gap-2">
            <Link href="/dashboard" className="rounded-full px-4 py-2 text-sm font-semibold text-neutral-700 hover:bg-neutral-100">
              Кабінет
            </Link>
            <Link
              href="/register"
              className="flex items-center gap-2 rounded-full bg-gradient-to-r from-blue-600 to-blue-500 px-4 py-2 text-sm font-semibold text-white shadow-md shadow-blue-200"
            >
              Додати СТО
            </Link>
          </div>
